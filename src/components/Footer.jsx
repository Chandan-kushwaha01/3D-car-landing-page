      ...
      <footer className="bg-[#131314] w-full max-w-[1350px] mx-auto text-white pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-28 rounded-tl-3xl rounded-tr-3xl overflow-hidden">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <NavLink to='/' className='flex items-center'>
              <div className="h-auto relative centered-row gap-2">
                ...
                {/* Text */}
                <p className={`tracking-tighter cursor-pointer text-xl clash-display font-medium text-zinc-200`}>
                  DriveWell <sup className='text-xs ml-1'>TM</sup>
                </p>
              </div>
            </NavLink>
            <p className="text-sm/6 text-neutral-300 max-w-96">Experience luxury and convenience with our premium car rental services. From economy to high-end vehicles, we deliver quality, reliability, and exceptional customer service for every trip.</p>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-4 border-t border-neutral-700 flex justify-between items-center">
          <p className="text-neutral-400 text-sm">
            &copy; {new Date().getFullYear()} Chandan Kushwaha
          </p>
          <p className='text-sm text-neutral-400'>All right reserved.</p>
        </div>
        <div className="relative">
          <div className="absolute inset-x-0 bottom-0 mx-auto w-full max-w-3xl h-full max-h-64 bg-sky-500 rounded-full blur-[170px] pointer-events-none" />
          <h3 className="text-center font-extrabold leading-[0.7] bg-gradient-to-r from-sky-400 to-white bg-clip-text text-transparent text-[clamp(3rem,15vw,15rem)] mt-6">
            Chandan
          </h3>
        </div>
      </footer>
