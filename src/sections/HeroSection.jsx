...
const HeroSection = () => {
  ...
  const handleSearch = (e) => {
    ...
    alert(`Searching in ${formData.location || 'all locations'} from ${formData.pickupDate} to ${formData.returnDate}`);
  };
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden pt-16 bg-black">
      ...
      <div className="mx-auto container absolute px-6 bottom-10 z-10 flex flex-col gap-16">
        ...
        {/* --- WORKING PREMIUM GLASS SEARCH BAR --- */}
        <motion.div
        ...
        >
          <form
            ...
            className="bg-zinc-900/40 backdrop-blur-2xl rounded-2xl md:rounded-full p-2 flex flex-col md:flex-row items-center border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
          >
            {/* Pickup Point Input */}
            <div className="flex-1 w-full px-8 py-3 md:border-r border-white/5 group cursor-text transition-all hover:bg-white/5 rounded-t-2xl md:rounded-l-full md:rounded-tr-none">
              ...
              <input
                ...
                className="bg-transparent border-none outline-none text-sm font-medium text-zinc-100 placeholder:text-zinc-600 w-full italic"
              />
            </div>

            {/* Rental Duration Inputs */}
            <div className="flex-[1.5] w-full px-8 py-3 md:border-r border-white/5 group transition-all hover:bg-white/5">
              <div className="flex items-center gap-2 mb-1">
              ...
              <div className="flex items-center gap-4">
                <input
                  ...
                  className="bg-transparent border-none outline-none text-xs font-medium text-zinc-300 [color-scheme:dark] cursor-pointer"
                />
            ...
            <div className="p-1 w-full md:w-auto">
              <button
                type="submit"
                className="w-full md:w-auto grad1 bg-sky-500 text-white px-12 py-4 rounded-xl md:rounded-full flex items-center justify-center gap-3 transition-all hover:brightness-125 active:scale-95 shadow-xl shadow-sky-500/20"
              >
